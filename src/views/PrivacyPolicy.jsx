...
Ako uočite da SARGON d.o.o. ne postupa prema ovim načelima ili imate bilo kakvu drugu primjedbu vezanu uz način poslovanja, obavijestite nas na naš email i mi ćemo upotrijebiti sve ekonomski opravdane napore da istražimo i ispravimo problem što je prije moguće.

SARGON d.o.o. web stranica koristi Google Analytics za potrebe remarketinga.

3. Druge web stranice i kolačići
Internet stranice SARGON d.o.o. sadrže linkove na druge Internet stranice, te Vas molimo da uzmete u obzir da SARGON d.o.o. ne može biti odgovorna za poštivanje privatnosti na istima. Ističemo važnost Izjave o privatnosti koju možete pronaći na svim drugim Internet stranicama te skrećemo pozornost na sadržaj iste. Ova Izjava i privatnosti primjenjuje se isključivo vezano uz informacije prikupljene na ovim Internet stranicama.
...
„Kolačići“ su opcija koju Vam nudi Vaš Web browser. Većina Web browsera je podešena tako da automatski prihvaća cookieje, no ukoliko Vi to želite, možete promijeniti postavke svog browsera tako da odbija kolačiće. IP adrese se koriste u svrhu analiziranja trendova i održavanja web stranice SARGON d.o.o., te iste nisu osobni podaci pomoću kojih se pojedinac može identificirati.

4. Marketinške aktivnosti
U slučaju da se želite prijaviti na primanje Newsletter-a SARGON d.o.o., zatražiti ćemo vaše odobne podatke poput imena i email adrese, koje ćemo isključivo koristiti u ove svrhe. U svakom trenutku se možete odjaviti sa spomenute liste klikom na „Unsuscribe“ na dnu pristoglog maila ili slanjem zahtjeva na naš email kojim ćete zatražiti da se Vaši podaci uklone sa iste.

5. Sigurnost korištenja Internet stranice
Internet stranica SARGON d.o.o. poduzimaju sve mjere kako bi zaštitile podatke o korisniku. Unošenjem povjerljivih podataka je u potpunosti sigurno i isti su zaštićeni. Pristup istima je ograničen i imaju ga samo osobe kojima su isti potrebni kako bi se tražena usluga kvalitetno i u potpunosti pružila.

6. Ograničenje na osobno, nekomercijano korištenje
...
7. Vlasništvo
Sadržaji i formati na ovim web stranicama su vlasništvo SARGON d.o.o., osim djela fotografija koje se ne koriste u komercijalne svrhe, a na zahtjev autora ili vlasnika bit će povučene sa stranica (ukoliko ne postignemo drugačiji dogovor).

8. Ograničenje od odgovornosti
Informacije na ovim stranicama smatraju se ispravnima u trenutku unošenja. Svi podaci redovito će se pregledavati, a eventualne greške odmah uklanjati. SARGON d.o.o. zadržava pravo promjene podataka na ovim stranicama bez posebnog upozorenja.
...
SARGON d.o.o. zadržava pravo promjena ovih uvjeta korištenja web stranica i drugih uvjeta poslovanja. Promjene ne utječu na već izvršene i uplaćene rezervacije.</div>
    </Helmet>
  )
}
